...
<div class="col-sm-2 " style="height:76px; background:#2D3E50;">
	...
	<div class=" col-xs-1 logo container">
		...
		<h1 class="titulo">Actulizar Profesor</h1>
</div>
...
<div class="container-fluid menu">
 ...
 <div class="col-md-3 col-sm-3 col-xs-2"></div>
	<div class="container-fluid col-xs-3 col-sm-3 col-md-3"><center><a href="{{ url('actualizarprofesor') }}"><img src="Iconos/ActualizarAlumno.svg" class="img-circle"></a><p><br><strong>Modificar Profesor<strong></p></center></div>
	<div class="col-xs-2 visible-xs"></div>
	<div class="container-fluid col-xs-3 col-sm-3 col-md-3"><center><a href="{{ url('eliminarprofesor') }}"><img src="Iconos/EliminarAlumno.svg" class="img-circle"></a><p><br><strong>Eliminar Profesor<strong></p></center></div> 
	<div class="col-md-3 col-sm-3 col-xs-2"></div>
</div>
