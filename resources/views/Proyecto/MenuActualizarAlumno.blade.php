...
<div class="col-sm-2 " style="height:76px; background:#2D3E50;">
	...
	<div class=" col-xs-1 logo container">
		...
		<h1 class="titulo">Actulizar Alumno</h1>
</div>
...
<div class="container-fluid menu">
 ...
 <div class="col-md-3 col-sm-3 col-xs-2"></div>
	<div class="container-fluid col-xs-3 col-sm-3 col-md-3"><center><a href="{{ url('actualizaralumno') }}"><img src="Iconos/ActualizarAlumno.svg" class="img-circle"></a><p><br><strong>Modificar Alumno<strong></p></center></div>
	<div class="col-xs-2 visible-xs"></div>
	<div class="container-fluid col-xs-3 col-sm-3 col-md-3"><center><a href="{{ url('eliminaralumno') }}"><img src="Iconos/EliminarAlumno.svg" class="img-circle"></a><p><br><strong>Eliminar Alumno<strong></p></center></div> 
	<div class="col-md-3 col-sm-3 col-xs-2"></div>
</div>
